...
1. To install tool chain type this command:
...
3. Install scons for python3:
```python
pip3 install scons
```

4. After installing required libraries, clone armcl from [here](https://github.com/ARM-software/ComputeLibrary.git):
...
```
7. Now open command line on you raspberry pi and run this lines:
